#!/bin/csh -f
# Link and run the public SDL clipboard API against OPENSTEP NSPasteboard.
set build_root = /tmp/SDL20/build/SDL-2.32.10-openstep
set mesa = /tmp/SDL20/mesa/Mesa-3.4.2
set test_source = /tmp/SDL20/src/test/openstep/openstep-sdl-clipboard-smoke.m
set test_binary = /tmp/SDL20/bin/openstep-sdl-clipboard-smoke

if (! -r $build_root/SDL-init-closure-gate.o) then
    echo "link-openstep-sdl-clipboard-smoke: build the SDL closure first"
    exit 2
endif
...
if ($status != 0) exit 1
echo "link-openstep-sdl-clipboard-smoke: PASS $test_binary (not run)"
