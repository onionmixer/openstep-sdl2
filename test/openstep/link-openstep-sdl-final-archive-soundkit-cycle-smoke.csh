#!/bin/csh -f
# Link repeated native SoundKit lifecycle smoke only against final libSDL2.a.
set build_root = /tmp/SDL20/build/SDL-2.32.10-openstep
set mesa = /tmp/SDL20/mesa/Mesa-3.4.2
set archive = $build_root/libSDL2.a
set test_source = /tmp/SDL20/src/test/openstep/openstep-sdl-final-archive-soundkit-cycle-smoke.c
set test_binary = /tmp/SDL20/bin/openstep-sdl-final-archive-soundkit-cycle-smoke

if (! -r $archive) then
    echo "link-openstep-sdl-final-archive-soundkit-cycle-smoke: build libSDL2.a first"
    exit 2
endif
...
if ($status != 0) exit 1
echo "link-openstep-sdl-final-archive-soundkit-cycle-smoke: PASS $test_binary (not run)"
