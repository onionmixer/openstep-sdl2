...
rm -f $test_binary
cc -m486 -Wall -D__OPENSTEP__ -I$build_root/include -I$build_root/src $test_source $build_root/src/atomic/SDL_atomic.c $build_root/src/atomic/SDL_spinlock.c -o $test_binary
if ($status != 0) exit 1
$test_binary
if ($status != 0) exit 1
echo "build-atomic-smoke: PASS $test_binary"
