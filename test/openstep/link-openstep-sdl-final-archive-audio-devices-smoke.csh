#!/bin/csh -f
# Link the SoundKit audio-enumeration smoke through final libSDL2.a.
...
set test_binary = /tmp/SDL20/bin/openstep-sdl-final-archive-audio-devices-smoke
set archive = $build_root/libSDL2.a

if (! -r $archive) then
    echo "link-openstep-sdl-final-archive-audio-devices-smoke: build libSDL2.a first"
    exit 2
endif
...
if ($status != 0) exit 1
echo "link-openstep-sdl-final-archive-audio-devices-smoke: PASS $test_binary (not run)"
