#!/bin/csh -f
# Link the public non-GUI CRC32/tokenizer smoke against the real SDL closure.
set build_root = /tmp/SDL20/build/SDL-2.32.10-openstep
set mesa = /tmp/SDL20/mesa/Mesa-3.4.2
set test_source = /tmp/SDL20/src/test/openstep/openstep-sdl-utility-smoke.c
set test_binary = /tmp/SDL20/bin/openstep-sdl-utility-smoke

if (! -r $build_root/SDL-init-closure-gate.o) then
    echo "link-openstep-sdl-utility-smoke: build the SDL closure first"
    exit 2
endif
...
if ($status != 0) exit 1
echo "link-openstep-sdl-utility-smoke: PASS $test_binary (not run)"
