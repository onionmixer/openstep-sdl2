#!/bin/csh -f
# Link the public SDL2 desktop display-mode enumeration smoke for OPENSTEP.
...
set test_binary = /tmp/SDL20/bin/openstep-sdl-display-modes-smoke

if (! -r $build_root/SDL-init-closure-gate.o) then
    echo "link-openstep-sdl-display-modes-smoke: build the SDL closure first"
    exit 2
endif
...
if ($status != 0) exit 1
echo "link-openstep-sdl-display-modes-smoke: PASS $test_binary (not run)"
