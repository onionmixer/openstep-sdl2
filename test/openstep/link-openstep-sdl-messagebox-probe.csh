...
set test_source = /tmp/SDL20/src/test/openstep/openstep-sdl-messagebox-probe.c
set test_binary = /tmp/SDL20/bin/openstep-sdl-messagebox-probe

if (! -r $build_root/SDL-init-closure-gate.o) then
    echo "link-openstep-sdl-messagebox-probe: build the SDL closure first"
    exit 2
endif
...
if ($status != 0) exit 1
echo "link-openstep-sdl-messagebox-probe: PASS $test_binary (not run)"
